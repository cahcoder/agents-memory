# AGENTS.md for Claude Code (claude.ai/code)

## Memory Integration

This AGENTS.md is automatically loaded by Claude Code when starting a session in this project.

### Semantic Memory Pipeline (WAJIB)

**ALWAYS RUN. NO SKIP.**

Semantic memory prevents context overflow and AI "gibberish" through semantic vector search.
...
# Intelligence
cd /srv/apps/semantic-clawmemory/skill && python3 memory_pre_llm.py "query"
```
